		...
		<main>
			<div class="hero">
				<section class="layout">
					...
					<div><img src="img/yamato.png" alt="Yamato" class="bouffon"/></div>

					<div class="videabsolu"></div>

				

					<div class="con" style="text-align: center; display: flex; flex-direction: column; align-items: center;">
						<h1 style="margin-bottom: 20px;">Un Bubble Tea digne d’un pirate !</h1>
					...
					<div><img src="img/teacollab.png" alt="tea collab" class="collab" /></div>
